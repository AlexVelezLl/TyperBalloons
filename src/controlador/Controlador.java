...
public final class Controlador {
    ...
    private static Pane pPausa;
    /**
     * Constructor vacio con modificador de acceso private para evitar que se puedan
    ...
    /**
     * Metodo que crea y estructura una interfaz para poder controlar el volumen de
     * la aplicacion.
     * 
     ...
     * el nuevo juego.
     * 
     * @return ImageView con el background de la pantalla donde se ejecuta el juego
     *         nuevo
     */
    ...
    /**
     * Metodo que modifica el nivel de verdad de los sonidos especiales de la
     * aplicacion
     * 
    ...
    /**
     * Metodo que modifica el imageView de la imagen de fondo de la pantalla
     * principal
     * 
    ...
    public static void setpPausa(Pane pPausa){
        Controlador.pPausa = pPausa;
    }
    /**
