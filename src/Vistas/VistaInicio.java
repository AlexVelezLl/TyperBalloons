...
public class VistaInicio {
    ...
    /**
     * Constructor de la clase donde se ubicara todos los elementos graficos de la
     * Vista Inicial.
     */
    public VistaInicio() {
        ...
        root.getChildren().addAll(Controlador.getbGIndex(), includeTitle(), includeButtons(), includeSN(),
                includeSettings(), onRoot);
    ...
    /**
     * Metodo donde se construyen los botones principales de la aplicacion: -INICIAR
     * JUEGO -VER PUNTAJES -Salir Cada uno con su respectiva funcionalidad
     * 
    ...
    /**
     * Metodo que retorna el pane que contiene el titulo de TyperBalloons que sera
     * ubicado en la interfaz principal
     * 
    ...
    /**
     * Metodo donde se construye y retorna el contenedor donde estaran ubicados los
     * respectivos botones de nuestras redes Sociales.
     * 
     ...
     * -Controlador de volumen de la aplicacion -Selector de si el usuario desea o
     * no efectos especiales -Selector de skin para la aplicacion
     * 
    ...
    /**
     * Funcion que crea y estructura el pane donde se mostraran las diferentes
     * dificultades de nuestro juego, cada una con su respectiva funcionalidad de
     * pasar al juego con la dificultad seleccionada, las dificultades son: -Facil
     * -Medio -Dificil
     * 
     * @return Pane con las opciones de juego que tiene el usuario al clickear en
     *         iniciar juego
     */
