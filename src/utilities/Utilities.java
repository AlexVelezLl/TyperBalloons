...
/**
 * Clase que contiene herramientas utiles que serviran a lo largo del desarrollo
 * del programa.
 * 
 * @author Alex Velez
 */
public final class Utilities {
    ...
    /**
     * Metodo que sirve para hacer una trancision entre dos roots pane en la misma
     * escena En la que aparecen muchos globos flotando hacia arriba.
     * 
    ...
    /**
     * Metodo que sirve para hacer una trancision entre dos roots pane en la misma
     * escena En la que se va opacando el primer root y luego va aclarandose el
     * otro.
     * 
     ...
     * @param cantidad entero con la cantidad de pixeles multiplicado por 3 que
     *                 deseemos que nuestro cartel baje
     */
     ...
     * 
     * @param nameImg String con el nombre de la imagen que tiene la imagen que
     *                queremos que haga de boton
    ...
    /**
     * Metodo que crea un pane con la animacion de un boton, en el que tiene texto
     * encima.
     * 
     * @param nameImg String con el nombre de la imagen que tiene la imagen que
     *                queremos que haga de boton
    ...
    /**
     * Metodo que reporta alguna excepcion que haya ocurrido en el pograma de una
     * manera adecuada
     * 
    ...
    public static Pane pPausa() {
        StackPane stPausa = new StackPane();
        stPausa.setMinWidth(790);
        stPausa.setMinHeight(570);
        Rectangle a = new Rectangle(CONSTANTES.WIDTH - 50, CONSTANTES.HEIGHT - 50);
        a.setOpacity(0.8);
        a.setArcHeight(75);
        a.setArcWidth(75);
        VBox menu = new VBox();
        ...
        Label lblPausa = new Label("PAUSA");
        
        lblPausa.setFont(CONSTANTES.FUENTE3);
        lblPausa.setTextFill(Color.WHITE);
        lblPausa.setTranslateX(175);
        Label lblVol = new Label("Volumen: ");
        lblVol.setFont(CONSTANTES.FUENTE);
        lblVol.setTextFill(Color.WHITE);

        Pane pVol = Controlador.volumenControl();
        Label lblSonidos = new Label("Efectos de sonido: ");
        lblSonidos.setFont(CONSTANTES.FUENTE);
        lblSonidos.setTextFill(Color.WHITE);

        Pane pCheckBox = Controlador.sonidEsp();
        HBox hbSondEs = new HBox();
        hbSondEs.getChildren().addAll(lblSonidos,pCheckBox);
        VBox vbOptions = new VBox();
        VBox vbVol = new VBox();
        vbVol.getChildren().addAll(lblVol,pVol);
        vbVol.setSpacing(15);
        vbOptions.setSpacing(50);
        vbOptions.getChildren().addAll(vbVol,hbSondEs);
        
        menu.getChildren().addAll(lblPausa,vbOptions);
        menu.setTranslateX(100);
        menu.setTranslateY(30);

        stPausa.getChildren().addAll(a,menu);
        return stPausa;
    }
}
