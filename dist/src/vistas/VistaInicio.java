...
public class VistaInicio{
     ...
     */
    public VistaInicio(){
        bG02 = new Image(CONSTANTES.RUTA_IMGS+"BG_03.png");
        bG01=new Image(CONSTANTES.RUTA_IMGS+"BG_01.png");
        root = new Pane();
        onRoot = new Pane();
        
        Controlador.setbGIndex(new ImageView());
        if(Controlador.getSkin()==2){       
            
            Controlador.getbGIndex().setImage(bG02);
    ...
    private Pane includeTitle(){
        ...
        if (Controlador.getSkin()==2){
            Controlador.setTitle(new ImageView(new Image(CONSTANTES.RUTA_IMGS+"TyperBallons_Title01.png")));
        }else{
    ...
    private Pane includeSettings(){
        ...
        if(Controlador.getSkin()==2)rect.setLayoutX(434);
        else rect.setLayoutX(174);
        ...
        eng.setOnMouseClicked(e->{
            try{
                ...
                ImageView skin2 = new ImageView(bG02);
